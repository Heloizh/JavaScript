...
const Header = () => {
  ...
  return (
    <div className='flex justify-between'>
      {/*Área de boas-vindas*/}
      <h1 className='text-sm font-semibold md:text-xl'>Welcome back {randomLink.name} &#x1F44B;</h1>
      ...
      <div className='flex gap-6 -mt-1 md:mt-0'>
        ...
        <input type="text" placeholder='Search...' className='h-10 w-12  md:w-96 rounded-3xl p-4 pr-16' />
        </div>
